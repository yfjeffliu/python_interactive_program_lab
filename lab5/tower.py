...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        if self.selected_tower.level  <= 4: #limit level smaller than 4
    ...
    def sell(self):
        ...
        self.__towers.remove(self.selected_tower)   #remove selected tower from list
        self.upgrade_menu = None                    #clear menu
        self.selected_tower = None                  #disable add new menu
